...
**修改位置：** [html5.html](file:///c:/Users/songl/Desktop/Hydro-master/packages/ui-default/addon/antd-beautify/templates/layout/html5.html#L515-L559)

**修改内容：**
- 将讨论列表左侧高亮条颜色从红色改为网站主色调蓝色
- 添加了渐变背景效果
- 添加了hover悬停效果
- 支持浅色模式和深色模式
...
|------|-----|
| 高亮条颜色 | `#1890ff`（蓝色） |
| 渐变背景 | 从左到右：rgba(24, 144, 255, 0.05) → transparent |
| hover背景 | rgba(24, 144, 255, 0.03) |

**深色模式：**
| 属性 | 值 |
|------|-----|
| 高亮条颜色 | `#60b6ff`（浅蓝色） |
| 渐变背景 | 从左到右：rgba(96, 182, 255, 0.1) → transparent |
| hover背景 | rgba(96, 182, 255, 0.05) |

---

### 6. 排名列表前三名特效

**修改位置：** [html5.html](file:///c:/Users/songl/Desktop/Hydro-master/packages/ui-default/addon/antd-beautify/templates/layout/html5.html#L580-L784)
...
| 排名 | 渐变背景 | 阴影颜色 |
|------|---------|---------|
| 第1名 | `#fef08a → #facc15 → #eab308`（金色） | rgba(234, 179, 8, 0.6) |
| 第2名 | `#e2e8f0 → #cbd5e1 → #94a3b8`（银色） | rgba(100, 116, 139, 0.5) |
| 第3名 | `rgba(254, 243, 199, 0.6) → rgba(251, 146, 60, 0.5) → rgba(234, 88, 12, 0.4)`（淡铜色） | rgba(234, 88, 12, 0.3) |

**深色模式特效：**
| 排名 | 渐变背景 | 阴影颜色 | 默认文字色 | hover文字色 |
|------|---------|---------|-----------|-------------|
| 第1名 | rgba(234, 179, 8, 0.35) → rgba(234, 179, 8, 0.5) → rgba(234, 179, 8, 0.35) | rgba(234, 179, 8, 0.6) | `#ffffff`（白色） | `#1a1a2e`（深色） |
| 第2名 | rgba(148, 163, 184, 0.25) → rgba(148, 163, 184, 0.35) → rgba(100, 116, 139, 0.25) | rgba(148, 163, 184, 0.5) | `#ffffff`（白色） | `#1a1a2e`（深色） |
| 第3名 | rgba(234, 88, 12, 0.1) → rgba(249, 115, 22, 0.15) → rgba(234, 88, 12, 0.1)（更淡的铜色） | rgba(234, 88, 12, 0.2) | `#ffffff`（白色） | `#1a1a2e`（深色） |
